  ...
  <main class="pb-12">
    ...
    <section>
      ...
      <div class="flex items-center justify-between max-w-xl mx-auto mt-4">
        ...
        <div
          class="flex-1 h-2 bg-gradient-to-r from-blue-500 dark:from-blue-800 to-bg-gray-500 to-dark:bg-gray-800"
        ></div>
        ...
        <div class="bg-blue-500 dark:bg-blue-800 p-8">
          ...
          <div v-for="(item, index) in templates" :key="index">
            <div class="flex flex-col mt-4">
              ...
              >
                <div
                  class="flex justify-center items-center bg-blue-500/50 dark:bg-blue-800/50 p-3 h-full"
                >
          ...
          >
            ...
            <p class="pl-2 text-lg">
              You can decide how you are working as a team first and than let
